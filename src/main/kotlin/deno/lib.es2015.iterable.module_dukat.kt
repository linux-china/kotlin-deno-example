...
external interface Iterator__1<T> : Iterator<T, Any, Nothing?>
...
external interface PromiseConstructor {
    fun <T> any(values: Array<dynamic /* T | PromiseLike<T> */>): Promise<T>
    fun <T> any(values: Iterable<dynamic /* T | PromiseLike<T> */>): Promise<T>
    fun <T : Any> allSettled(values: T): Promise<Any>
