...
external interface AsyncIterator<T, TReturn, TNext> {
    ...
    val `return1`: ((value: TReturn) -> Promise<dynamic /* IteratorYieldResult<T> | IteratorReturnResult<TReturn> */>)?
        get() = definedExternally
    val `return2`: ((value: PromiseLike<TReturn>) -> Promise<dynamic /* IteratorYieldResult<T> | IteratorReturnResult<TReturn> */>)?
        get() = definedExternally
